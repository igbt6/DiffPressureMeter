...
extern SPI spii;
//#define __LCD_WRITE_BYTE(__DATA) HwInterfaces::instance().getHwInterface<SPI__1>().handle().write(__DATA)
//#define __LCD_WRITE_BYTE(__DATA) HwInterfaces::instance().getHandleSPI1().write(__DATA)
