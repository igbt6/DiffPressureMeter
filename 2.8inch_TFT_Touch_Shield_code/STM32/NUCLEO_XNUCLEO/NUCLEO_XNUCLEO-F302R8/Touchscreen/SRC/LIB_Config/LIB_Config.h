...
#define LCD_SDI_GPIO   GPIOB
#define LCD_SDO_GPIO   GPIOB
...
#define __LCD_WRITE_BYTE(__DATA)       spi_read_write_byte(SPI2, __DATA)
...
#define __XPT2046_WRITE_BYTE(__DATA)       spi_read_write_byte(SPI2, __DATA)
