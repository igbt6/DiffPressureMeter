...
void LUTFT::print(const char *st, int x, int y, int deg)
{
    int stl, i;
...
void LUTFT::runDemo(LUTFT &tft, int loop_num)
{
    int loops = 0;
    while(loops < loop_num)
    {
        ...
        tft.print("Restarting in ", CENTER, 119);
        tft.print("10 seconds...", CENTER, 132);
