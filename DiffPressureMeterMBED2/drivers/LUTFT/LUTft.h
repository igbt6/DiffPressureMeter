/*
  ...
  based on UTFT library developed by Henning Karlsen
...
#define LCD_CS_OUT()    _cs(LCD_CS_PIN, HIGH)
#define LCD_CS_CLR()    _cs.write(LOW)
#define LCD_CS_SET()    _cs.write(HIGH)

#define LCD_DC_OUT()    _dc(LCD_DC_PIN, HIGH)
#define LCD_DC_CLR()    _dc.write(LOW)
#define LCD_DC_SET()    _dc.write(HIGH)

#define LCD_BKL_OUT()   _bkl(LCD_BKL_PIN, LOW)
#define LCD_BKL_OFF()   _bkl.write(LOW)
#define LCD_BKL_ON()    _bkl.write(HIGH)
...
class LUTFT
{
    public:
        ...
        static void runDemo(LUTFT &tft, int loop_num);
